      ...
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
        ...
        <div className="space-y-6">
          ...
          <div className="pb-6 border-b border-gray-200 dark:border-gray-800">
            ...
            <ul className="space-y-3">
              <li className="text-gray-600 dark:text-gray-400">
                <strong>How do I access the lineman panel?</strong>
                <p className="mt-1 text-sm">Navigate to your dashboard after logging in to access all lineman features.</p>
              </li>
              <li className="text-gray-600 dark:text-gray-400">
              ...
              <li className="text-gray-600 dark:text-gray-400">
                <strong>How do I manage system operations?</strong>
                <p className="mt-1 text-sm">Access the relevant sections from the lineman dashboard to manage operations.</p>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Check out our comprehensive documentation for detailed guides on using the lineman platform.
            </p>
